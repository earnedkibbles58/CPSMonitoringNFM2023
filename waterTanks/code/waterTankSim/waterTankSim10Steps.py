...
def main():
    ...
    if trimming:
        plotSaveDir = "../../results/monitorPlots/manyStates10Steps/withTrimming/upperLimit90/deltawl_" + str(delta_wl) + "_" + str(numTrials) + "Trials/"
    else:
        plotSaveDir = "../../results/monitorPlots/manyStates10Steps/noTrimming/upperLimit90/deltawl_" + str(delta_wl) + "_" + str(numTrials) + "Trials/"
    ...
    for j in range(numTrials):
        ...
        wlMax=100
        wlInit1=random.uniform(1,wlMax-1)
        wlInit2=random.uniform(1,wlMax-1)
                
        ctrlThreshLower = 10
        ctrlThreshUpper = 90
        
        numStepsPRISM = 10
        contAction1 = random.randint(0,1)
        contAction2 = random.randint(0,1)
        ...
        #     plt.plot(wlEsts2,'g')
        #     plt.ylim(0, wlMax)
        #     plt.savefig("tempTrialPlotState" + str(initWL1) + "_" + str(initWL2) + "_" + str(initControl1) + str(initControl2) + ".png")
    ...
    print("True state safe: " + str(sum(trueSafeProbs)/numTrials))

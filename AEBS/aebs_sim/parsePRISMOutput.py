...
def computeViolationAEBSKnownControl(distInd,velInd,obstClass,contCommand,base_dir):
    
    
    if obstClass == 0:
        file_name = base_dir + "noObst/contAction_" + str(contCommand) + "/initVelInd_" + str(velInd) + "/violationProb.txt"
    elif obstClass == 1:
        file_name = base_dir + "carObst/contAction_" + str(contCommand) + "/initVelInd_" + str(velInd) + "_initDistInd_" + str(distInd) + "/violationProb.txt"
    else:
        return -1
